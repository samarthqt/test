...
public class LiveTrackingPage extends WebReusableComponents {
    ...
    public void verifyLiveTrackingOnMobileDevice() {
        Assert.assertTrue(isMobileTrackingConsistent(), "Live tracking on mobile device is inconsistent.");
    }
    ...
    public void checkLiveTrackingAfterReboot() {
        Assert.assertTrue(isLiveTrackingAccurateAfterReboot(), "Live tracking accuracy failed after reboot.");
    }
