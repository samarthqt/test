...
public class LiveTrackingPage extends WebReusableComponents {
    ...
    public boolean isLocationUpdateSuccessfulFromDifferentDevice() {
        return getDriver().findElement(currentLocation).getText().contains("Updated from another device");
    }

    public boolean isLiveTrackingAccurateAfterReboot() {
        return getDriver().findElement(currentLocation).getText().contains("Accurate after reboot");
    }
