...
/**
 * ShipmentTrackingPage class provides methods to interact with the shipment tracking functionalities.
 */
public class ShipmentTrackingPage {
    ...
    /**
     * Navigates to the Orders Module and verifies its visibility.
     */
    ...
    /**
     * Selects an order by its ID and verifies the order details visibility.
     * 
    ...
    /**
     * Updates the shipment status to 'Dispatched' and verifies the update.
     */
    ...
    /**
     * Retrieves a list of WebElements matching the specified locator.
     * 
