...
public class ShipmentPage extends WebReusableComponents {
    ...
    public void checkNotificationSettings() {
        WebElement notificationSettingsElement = waitUntilElementVisible(notificationSettings, 10);
        Assert.assertTrue(notificationSettingsElement.isDisplayed(), "Notification settings check failed.");
    }
