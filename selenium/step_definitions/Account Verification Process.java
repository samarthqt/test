...
public class AccountVerificationSteps extends AccountVerificationPage {
    ...
    public void theAccountVerificationIsSuccessful() {
        String expectedMessage = testHarness.getData("AccountData", "SuccessMessage");
        verifyAccountVerificationSuccess(expectedMessage);
    }

    @Then("the account verification fails")
    public void theAccountVerificationFails() {
        String expectedErrorMessage = testHarness.getData("AccountData", "ErrorMessage");
        verifyAccountVerificationFailure(expectedErrorMessage);
    }
    ...
    public void theCustomerIsRedirectedToTheirAccountDetailsPage() {
        ...
        verifyRedirectionToAccountDetailsPage(expectedURL);
    }
    ...
    public void theAccountStatusRemainsAsUnverified() {
        verifyAccountStatusRemains("Unverified");
    }
