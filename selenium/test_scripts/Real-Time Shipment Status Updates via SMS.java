...
public class ShipmentTrackingAutomation {
    public static void main(String[] args) {
        ...
        WebElement updateStatusButton = driver.findElement(By.id("updateStatus"));
        updateStatusButton.click();
        WebElement statusDropdown = driver.findElement(By.id("statusDropdown"));
        statusDropdown.sendKeys("To be delivered");
        updateStatusButton.click();

        // Simulate a status update to 'Delivered'
        statusDropdown.sendKeys("Delivered");
        updateStatusButton.click();
        ...
        System.out.println("History Log: " + historyLog.getText());
        ...
        // This step would require a different setup and cannot be simulated directly with Selenium

        // Verify the shipment status using SMS on a mobile device
        // This step would require integration with an SMS service and cannot be directly tested with Selenium

        // Check the shipment status after a system reboot
        // This step would require restarting the system and cannot be directly automated with Selenium
