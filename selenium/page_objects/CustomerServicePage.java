...
public class CustomerServicePage extends WebReusableComponents {
    ...
    public void clickPhoneNumber() {
        ...
        phoneNumber.click();
        Assert.assertTrue(phoneNumber.isDisplayed(), "Phone number is clicked.");
    }

    public void clickEmailAddress() {
        WebElement emailAddress = driver.findElement(emailAddresses);
        emailAddress.click();
        Assert.assertTrue(emailAddress.isDisplayed(), "Email address is clicked.");
    }

    public void clickChatLink() {
        WebElement chatLink = driver.findElement(chatLinks);
        chatLink.click();
        Assert.assertTrue(chatLink.isDisplayed(), "Chat link is clicked.");
    }
