...
public class CheckoutPage {
    ...
    public void payWithPayPal() {
        waitUntilElementVisible(btnPayWithPayPal);
        driver.findElement(btnPayWithPayPal).click();
        waitUntilElementVisible(btnLoginToPayPal);
        driver.findElement(btnLoginToPayPal).click();
        waitUntilElementVisible(btnConfirmPayPalPayment);
        driver.findElement(btnConfirmPayPalPayment).click();
    }
