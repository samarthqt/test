...
public class WebpageExecutor extends WebReusableComponents {
	...
	@Given("user launch the application {string} with {string}")
	public void user_launch_the_application_with(String url, String appliTools) throws Exception {
