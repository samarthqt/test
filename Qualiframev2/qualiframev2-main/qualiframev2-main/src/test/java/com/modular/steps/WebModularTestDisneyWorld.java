...
public class WebModularTestDisneyWorld extends TestConfigurationsLite {

    public WebDriver driver;

    @Test(dataProvider = "EDGEBrowser", dataProviderClass = TestConfigurationsLite.class)
    public void seleniumPracticeTest(SeleniumTestParameters testParameters) {
        testParameters.setCurrentTestDescription("Test for Sample Selenium Test1");
    ...
    public void Success() {
        WebDisney sp = new WebDisney(scriptHelper);
//        sp.refresh();
        sp.clickVirtualAssistant();
        sp.switchToIframeContainer();
//        sp.clickOrderStatus();
//        sp.ClickYes();
//        sp.ClickNo();
    }
