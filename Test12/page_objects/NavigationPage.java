...
public class NavigationPage extends WebReusableComponents {
    ...
    public void navigateToAnyPage() {
        waitUntilElementVisible(navigationMenu, 3);
    ...
    public void verifyConsistentNavigation() {
        Assert.assertTrue(isElementDisplayed(navigationMenu), "Navigation is not consistent.");
    }
}