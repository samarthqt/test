...
Evaluate the system's handling of boundary conditions with tracking information. User must have a valid customer account.
@TC-18
Scenario: Handling long shipment ID in tracking information
