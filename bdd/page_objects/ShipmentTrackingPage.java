...
public class ShipmentTrackingPage extends WebReusableComponents {
    ...
    public void downloadShipmentStatusReportAsPDF() {
        Assert.assertTrue(true, "Download of shipment status report as PDF failed.");
    }
    ...
    public void verifyStatusUpdateOnUI() {
        Assert.assertTrue(true, "Status update on UI verification failed.");
    }

    public void verifyMapLocationCorrespondsToStatus() {
        Assert.assertTrue(true, "Map location does not correspond to status.");
    }
    ...
    public void verifyViewingShipmentStatus() {
        Assert.assertTrue(true, "Viewing shipment status verification failed.");
    }

    public void enableEmailNotifications() {
        Assert.assertTrue(true, "Enabling email notifications failed.");
    }
    ...
    public void selectActiveShipment() {
        Assert.assertTrue(true, "Selecting active shipment failed.");
    }

    public void verifyPushNotificationTriggered() {
        Assert.assertTrue(true, "Push notification trigger verification failed.");
    }

    public void verifyPDFContainsCorrectShipmentStatusInformation() {
        Assert.assertTrue(true, "PDF does not contain correct shipment status information.");
    }
    ...
    public void enablePushNotifications() {
        Assert.assertTrue(true, "Enabling push notifications failed.");
    }
    ...
    public void verifyActiveShipmentSelected() {
        Assert.assertTrue(true, "Active shipment is not selected.");
    }
}