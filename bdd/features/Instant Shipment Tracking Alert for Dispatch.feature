...
@TC-3
Scenario: Verify instant alert for shipment dispatch
Given a shipment order exists in the system with Order ID 333
And the customer has subscribed to shipment alerts
And the customer email is customer@qualitest.com
...
Then an alert should be sent to customer@qualitest.com notifying them of the shipment status
