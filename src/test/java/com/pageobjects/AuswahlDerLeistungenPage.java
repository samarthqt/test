...
public class AuswahlDerLeistungenPage extends WebReusableComponents {
    ...
    public AuswahlDerLeistungenPage() {
    ...
    private void waitUntilElementVisible(By locator, int timeout) {
        ...
        Assert.assertNotNull(element, "Element not visible: " + locator.toString());
    }
