...
public class LoginPage extends WebReusableComponents {
    ...
    /**
     * Verifies that the login form is accessible.
     */
    public void verifyLoginFormAccessibility() {
        Assert.assertTrue(isElementVisible(txtUserName) && isElementVisible(txtPassword), "Login form is not accessible.");
    }
