...
public class AccountsPayablePage extends WebReusableComponents {
    ...
    public void navigateToAccountsPayable() {
        ...
        Assert.assertTrue(isElementDisplayed(accountsPayableModule), "Navigated to Accounts Payable module.");
    }

    public void verifyAccountsPayableModuleAccess() {
        waitUntilElementVisible(accountsPayableModule, 3);
        Assert.assertTrue(isElementDisplayed(accountsPayableModule), "Accounts Payable module is accessible.");
    }

    public void verifyAccountsPayableFeatures() {
        // Logic to verify Accounts Payable features
    ...
    public void verifyInvoiceDisplayedInList() {
        ...
        boolean invoiceFound = getWebElementList(invoiceList)
            .stream()
            .anyMatch(item -> item.getText().contains("Invoice"));
        Assert.assertTrue(invoiceFound, "Invoice displayed in list.");
    }
    ...
    public void verifyInvoiceNotInList() {
        ...
        boolean invoiceFound = getWebElementList(invoiceList)
            .stream()
            .noneMatch(item -> item.getText().contains("Invoice"));
        Assert.assertTrue(invoiceFound, "Invoice not in list.");
    }
    ...
    public void verifyPaymentCompletion() {
        ...
        Assert.assertTrue(true, "Payment completed successfully.");
    }
    ...
    public void verifyAccessRestriction() {
        ...
        Assert.assertTrue(isElementDisplayed(errorMessage), "Access restriction displayed.");
    }
}