...
public class GruSi_AntragEinreichenPage extends WebReusableComponents {
    ...
    protected By lnkdownloadXML = By.xpath("//a[@id='downloadXML']");
    protected String lnkdownloadXMLXpath = "//a[@id='downloadXML']";

    public GruSi_AntragEinreichenPage() {
    ...
    public void downloadXMLFile() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(lnkdownloadXML));
        ((JavascriptExecutor) driver).executeScript("document.evaluate('" + lnkdownloadXMLXpath + "', document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.click();");
        waitUntil(10);
    }
}