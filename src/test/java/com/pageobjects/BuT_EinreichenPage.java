...
public class BuT_EinreichenPage extends WebReusableComponents {
    ...
    protected By pageHeader = By.xpath("//h3[@id='LB_Absenden']");

    public BuT_EinreichenPage() {
    ...
    public void lade_Seite_Einreichen() {
        waitUntilElementVisible(pageHeader, 30);
        WebElement headerElement = driver.findElement(pageHeader);
        Assert.assertTrue(headerElement.isDisplayed(), "Page header is not visible.");
    }
}