...
public class AccountsPayableSteps extends AccountsPayablePage {
    ...
    public void theReportsShouldContainAccurateAndCompleteInformationRelatedToAccountsPayable() {
    ...
    public void iShouldBeSuccessfullyLoggedOutFromTheSystemAndDirectedToTheLoginPage() {
    ...
    public void theSystemShouldRestrictAccessAndDisplayAnAppropriateErrorMessageOrNotification() {
