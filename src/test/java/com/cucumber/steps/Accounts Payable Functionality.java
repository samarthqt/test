...
import com.pageobjects.AccountsPayablePage;
...
public class AccountsPayableSteps extends AccountsPayablePage {
    ...
    public void iShouldBeAbleToSeeAndAccessAllNecessaryOptionsAndFeatures() {
    ...
    public void theSystemShouldDisplayTheNewlyCreatedInvoice() {
    ...
    public void theSystemShouldNotDisplayTheDeletedInvoice() {
    ...
    public void theSystemShouldRecordAndUpdateThePaymentInformation() {
    ...
    public void iShouldBeAbleToViewAndDownloadTheReports() {
