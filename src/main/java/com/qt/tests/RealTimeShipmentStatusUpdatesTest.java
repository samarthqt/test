...
public class RealTimeShipmentStatusUpdatesTest {
    ...
    public void setUp() {
        ...
        shipmentTrackingPage.launchShipmentTrackingPage();
    }
    ...
    public void testRealTimeShipmentStatusUpdates() {
        ...
        assertTrue(shipmentTrackingPage.verifyTimestamp());
        ...
        assertTrue(shipmentTrackingPage.checkNotificationSettings());
