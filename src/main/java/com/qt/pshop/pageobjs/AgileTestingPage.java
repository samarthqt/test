...
public class AgileTestingPage extends WebReusableComponents {
    ...
    public void clickAgileTestingSubMenu() {
        ...
        element.click();
        Assert.assertTrue(element.isDisplayed(), "Agile Testing Sub Menu is not displayed after click.");
    }
    ...
    public void clickScaleAgileLearnMore() {
        ...
        element.click();
        Assert.assertTrue(element.isDisplayed(), "Scale Agile Learn More link is not displayed after click.");
    }
    ...
    public void clickExplorerTestingLearnMore() {
        ...
        element.click();
        Assert.assertTrue(element.isDisplayed(), "Explorer Testing Learn More link is not displayed after click.");
    }
    ...
    public void clickDistributedTeamLearnMore() {
        ...
        element.click();
        Assert.assertTrue(element.isDisplayed(), "Distributed Team Learn More link is not displayed after click.");
    }
    ...
    public void clickIntegrationAPIsLearnMore() {
        ...
        element.click();
        Assert.assertTrue(element.isDisplayed(), "Integration APIs Learn More link is not displayed after click.");
    }
}